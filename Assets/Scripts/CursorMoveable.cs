...
public class CursorMoveable : MonoBehaviour, IDragHandler
{
    ...
    void IDragHandler.OnDrag(UnityEngine.EventSystems.PointerEventData eventData)
    {
        ...
        if (m_clampToPlayArea)
        {
            ...
            if (m_rectTransform.transform.localPosition.x + m_rectTransform.rect.x < m_playAreaBounds.transform.localPosition.x + m_playAreaBounds.rect.x)
            {
                // get the left most valid position of this object and store it in the clamp vector
                m_clampedPosition.x = m_playAreaBounds.transform.localPosition.x + m_playAreaBounds.rect.x - m_rectTransform.rect.x;
            }
            // if the right most bound of this object is beyond the right most point of the play area
            else if (m_rectTransform.transform.localPosition.x - m_rectTransform.rect.x > m_playAreaBounds.transform.localPosition.x - m_playAreaBounds.rect.x)
            {
            ...
            if (m_rectTransform.transform.localPosition.y + m_rectTransform.rect.y < m_playAreaBounds.transform.localPosition.y + m_playAreaBounds.rect.y)
            {
                // get the lowest valid position of this object and store it in the clamp vector
                m_clampedPosition.y = m_playAreaBounds.transform.localPosition.y + m_playAreaBounds.rect.y - m_rectTransform.rect.y;
            }
            // if the highest bound of this object is beyond the highest point of the play area
            else if (m_rectTransform.transform.localPosition.y - m_rectTransform.rect.y > m_playAreaBounds.transform.localPosition.y - m_playAreaBounds.rect.y)
            {
